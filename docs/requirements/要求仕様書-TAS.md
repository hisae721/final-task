...
- 本機能では、不正な操作によるエラーを未然に防ぐ設計とする

  - 【無効化状態での開始防止】
　　 設定時間が00:00:00の場合、開始ボタンは押下出来ない

  - 【多重押下制御】
　　 開始／一時停止ボタンの連続押下を防止する
...
- 現時刻から比較し、過去時刻を設定した場合、次の日の設定とする
